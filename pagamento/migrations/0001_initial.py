...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Cupom',
            fields=[
                ('codigo', models.CharField(max_length=100, unique=True, verbose_name='cupom')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('valor', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='valor pagamento')),
                ('cupom_codigo', models.CharField(blank=True, max_length=100, null=True, verbose_name='cupom')),
            ],
        ),
    ]
