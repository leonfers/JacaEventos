...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('atividade', models.ForeignKey(blank=True, default='', on_delete=django.db.models.deletion.CASCADE, to='core.AtividadeAbstrata')),
        ...
        migrations.AddField(
            ...
            name='atividades',
            field=models.ManyToManyField(through='user.ItemInscricao', to='core.AtividadeAbstrata'),
        ),
        migrations.AddField(
            model_name='inscricao',
            name='evento',
