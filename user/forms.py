...
from core.models import Evento, TipoEvento, Tag, Instituicao, GerenciaEvento, EventoInstituicao, EventoSatelite, Trilha, \
    AtividadePadrao, AtividadeAdministrativa, AtividadeContinua
