...
class TestUser(TestCase):
    def setUp(self):
        ...
        usuario.save()
        self.user = usuario
        endereco = Endereco.objects.create(pais="Brasil", estado="Piaui", logradouro="Praca", numero="3130", cidade="Teresina",
        ...
        evento = Evento(nome="Festival",
                        ...
                        valor=0, tipo_evento=TipoEvento.SEMINARIO, periodo=self.periodo, endereco=endereco, dono=usuario)
        evento.save()
        atividade = AtividadeContinua(nome="teste", descricao="Credenciamento dos participantes",
