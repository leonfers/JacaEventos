...
class EventosSerializer(serializers.ModelSerializer):
    dono = serializers.CharField(source='get_dono', read_only=False)
   # tipo = serializers.CharField(source='get_tipo', read_only=True)
    ...
    class Meta:
        model = Evento
        fields = ('id', 'nome', 'descricao','dono' ,'valor', 'periodo', 'endereco')


class AtividadeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Atividade
        fields = ('id', 'nome', 'valor', 'evento', 'periodo', 'horario')
